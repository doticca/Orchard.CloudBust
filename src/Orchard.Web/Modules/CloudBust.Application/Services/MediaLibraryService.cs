...
namespace CloudBust.Application.Services {
    ...
    public class MediaLibraryService : IMediaLibraryService
    {
        ...
        {
            if (_orchardServices.Authorizer.Authorize(Orchard.MediaLibrary.Permissions.ManageMediaContent))
            {
                return null;
            }
        ...
        public void CreateFolder(string relativePath, string folderName)
        {
            ...
            string folder = relativePath == null ? folderName : _storageProvider.Combine(relativePath, folderName);
