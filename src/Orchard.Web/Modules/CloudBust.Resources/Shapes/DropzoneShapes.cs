...
namespace CloudBust.Resources.Shapes
{
    ...
    public class DropzoneShapes : IShapeTableProvider
    {
        private readonly Work<WorkContext> _workContext;
        private readonly IDropzoneService _dropzoneService;
        public DropzoneShapes(Work<WorkContext> workContext, IDropzoneService dropzoneService)
        {
        ...
        public void Discover(ShapeTableBuilder builder)
        {
            builder.Describe("HeadScripts")
                ...
                {
                    if (!_dropzoneService.GetAutoEnable()) return;
                    if (!_dropzoneService.GetAutoEnableAdmin())
                    {
