...
namespace Contrib.Voting.Services {
    public class DefaultVotingService : IVotingService {
        ...
        public IEnumerable<ResultRecord> GetResults(int count, string function, string dimension = null)
        {
           return _resultRepository.Fetch(r => r.Dimension == dimension && r.FunctionName == function, o => o.Desc(r => r.Value), 0, count);           
        }
