...
namespace Orchard.AuditTrail.Providers.ContentDefinition {
    ...
    public class ContentDefinitionEventHandler : IContentDefinitionEventHandler {
        ...
        public void ContentFieldAttached(ContentFieldAttachedContext context) {
            ...
            _auditTrailManager.CreateRecord<ContentPartAuditTrailEventProvider>(ContentPartAuditTrailEventProvider.FieldAdded, _wca.GetContext().CurrentUser, null, eventData, "contentpart", context.ContentPartName);
        }
        ...
        public void ContentFieldDetached(ContentFieldDetachedContext context) {
            ...
            _auditTrailManager.CreateRecord<ContentPartAuditTrailEventProvider>(ContentPartAuditTrailEventProvider.FieldRemoved, _wca.GetContext().CurrentUser, null, eventData, "contentpart", context.ContentPartName);
        }
        ...
        private void RecordContentTypeAuditTrailEvent(string eventName, ContentTypeDefinition contentTypeDefinition, XElement previousContentTypeXml = null, XElement newContentTypeXml = null) {
            ...
            if (record)
                _auditTrailManager.CreateRecord<ContentTypeAuditTrailEventProvider>(eventName, _wca.GetContext().CurrentUser, null, eventData, "contenttype", contentTypeDefinition.Name);
        }
        ...
        private void RecordContentPartAuditTrailEvent(string eventName, ContentPartDefinition contentPartDefinition, XElement previousContentPartXml = null, XElement newContentPartXml = null) {
            ...
            if (record)
                _auditTrailManager.CreateRecord<ContentPartAuditTrailEventProvider>(eventName, _wca.GetContext().CurrentUser, null, eventData, "contentpart", contentPartDefinition.Name);
        }
        ...
        private void RecordContentTypePartAuditTrailEvent(string eventName, string contentTypeName, string contentPartName) {
            ...
            _auditTrailManager.CreateRecord<ContentTypeAuditTrailEventProvider>(eventName, _wca.GetContext().CurrentUser, null, eventData, "contenttype", contentTypeName);
        }
    }
}